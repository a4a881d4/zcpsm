...
struct nodestruct *exp;
{
    ...
    {
    case ADDABOP:
	_zcc_addab(source,target);
	break;
    case SUBABOP:
	_zcc_subab(source,target);
	break;
    case ANDABOP:
	_zcc_opab(source,target,"AND");
	break;
    case ORABOP:
    	_zcc_opab(source,target,"OR");
    	break;
    case SLABOP:
    	_zcc_sl(source,target);
    	break;
    case SRABOP:
    	_zcc_sr(source,target);
    	break;
    case EORABOP:
    	_zcc_opab(source,target,"XOR");
    	break;
    case DIVABOP:
    case MODABOP:
    case MULABOP:
    ...
    case EOROP:
    case OROP:
	_zcc_op1(op, source, target);
	break;
    case ASSIGNOP:
	_zcc_assign(source, target);
	break;
    case CASTOP:
